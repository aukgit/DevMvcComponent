 ...
 * as properties on a global Modernizr object, and as list on the
...
window.Modernizr = (function( window, document, undefined ) {
    ...
    /*>>cssclasses*/
    // option for enabling the HTML list to be added
    enableClasses = true,
    /*>>cssclasses*/
    ...
    for ( var feature in tests ) {
        if ( hasOwnProp(tests, feature) ) {
            ...
            //   and push it into an array of list we'll join later.
    ...
    /*jshint evil:true */
       ...
       * @private
       * @param {Document} ownerDocument The document.
       * @returns {value} An object of data.
       */
       ...
       * @returns {value} The shived element.
       */
       ...
       * @memberOf html5
       * @param {Document} ownerDocument The context document.
       * @returns {value} The shived DocumentFragment.
       */
       ...
       * @param {value} data of the document.
       */
    ...
    docElement.className = docElement.className.replace(/(^|\s)no-js(\s|$)/, '$1$2') +
                            ...
                            // Add the new list to the <html> element.
