...
using System.Web;
using System.Linq;
using DevOrgDb = DevMVCComponent.Database.Initializer.Models;

namespace DevMVCComponent.TimeZone {
    ...
    public class Zone {
        ...
        static string SessionZoneName = "DevelopersOrganismZoneName";
        static List<DevOrgDb.TimeZone> dbTimeZones;
        ...
        public static void RemoveTimeZoneCache(string log) {
            ...
            Starter.Cookies.Remove(SessionZoneName);
            Starter.Caches.Remove(SessionZoneName + log);
        }
