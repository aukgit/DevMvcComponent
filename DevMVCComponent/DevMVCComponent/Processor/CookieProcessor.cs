...
namespace DevMvcComponent.Processor
{
    ...
    public class CookieProcessor
    {
        ...
        /// <returns></returns>
        public bool Exists(string name) => HttpContext.Current.Request.Cookies.AllKeys.Contains(name);
        ...
        public string Get(string cookieName) => ReadString(cookieName);
