...
namespace DevMvcComponent.Extensions {
    ...
    public static class ClassExtention {
        ...
        /// <summary>
        /// Get all public static and constant values : BindingFlags.Public | BindingFlags.Static | BindingFlags.FlattenHierarchy
        /// </summary>
        ...
        public static IEnumerable<ObjectProperty> GetConstantsAsObjectProperties(this Type type) {
            ...
            return fields.Select(n => new ObjectProperty() {
                Name = n.Name,
